...
export interface ConvertChildToCbObjResp {
  index: number;
  item: any;
}

export type RenderArrowProps = {
  type: typeof constants.NEXT | typeof constants.PREV;
...
export interface ReactElasticCarouselProps {
  ...
  renderArrow?: (props: RenderArrowProps) => JSX.Element;
  ...
  onChange?: (currentItemObject: ConvertChildToCbObjResp, currentPageIndex: number) => void;
  //  A callback for the beginning of the next transition
  onNextStart?: (
    prevItemObject: ConvertChildToCbObjResp,
    nextItemObject: ConvertChildToCbObjResp
  ) => void;
  ...
  onNextEnd?: (nextItemObject: ConvertChildToCbObjResp, currentPageIndex: number) => void;
  //  A callback for the end of the prev transition
  onPrevEnd?: (nextItemObject: ConvertChildToCbObjResp, currentPageIndex: number) => void;
